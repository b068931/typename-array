...
template<typename_array_size_t index_to_erase, typename array>
struct erase {
public:
	template<typename_array_size_t index, typename helper_array>
	struct erase_helper;
	...
	template<typename_array_size_t index, template<typename, typename...> class array_template, typename type, typename... other>
