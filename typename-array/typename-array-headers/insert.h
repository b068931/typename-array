...
template<typename_array_size_t insert_index, typename array, typename new_type>
struct insert {
private:
	...
	template<typename_array_size_t index, template<typename, typename...> class array_template, typename helper_new_type, typename value, typename... other>
